...
import campusLogo from "../../assets/nrcmc.jpg";
...
const Certificate = ({ courseData, studentName, completionDate }) => {
  return (
    <div className="certificate-container">
      <div className="badge">EduConnect</div>
      ...
      <div className="text">
        ...
        <strong>EduConnect Skill Enhancement Series</strong>.
      </div>
      ...
      <div className="certificate-signature">
        ...
        <div className="signature-block">
          ...
          <div className="signature-title">EduConnect</div>
        </div>
      </div>
    </div>
  );
